...
class ModelBlogArticle extends Model {
    ...
    public function getArticles($data = array()) {
        ...
        $sql .= " LEFT JOIN " . DB_PREFIX . "article_to_list atl ON (a.article_id = atl.article_id) ";
        ...
        if (!empty($data['filter_list'])) {
            $sql .= " AND atl.article_list_id = ".$data['filter_list'];
        }
    ...
    public function getArticlesList($article_list_id) {
    ...
    public function getArticleListDescription($article_id) {
        $sql = "SELECT * FROM " . DB_PREFIX . "article_list al
        LEFT JOIN " . DB_PREFIX . "article_list_description ald ON al.article_list_id = ald.article_list_id
        LEFT JOIN " . DB_PREFIX . "article_to_list atl ON al.article_list_id = atl.article_list_id
        WHERE atl.article_id = '" . (int)$article_id . "'
        AND ald.language_id = '" . (int)$this->config->get('config_language_id') . "'";
        $query = $this->db->query($sql);
