        ...
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-setting" class="form-horizontal">
          ...
          <div class="tab-content">
            ...
            <div class="tab-pane" id="tab-store">
              ...
              <div class="tab-content">
                ...
                <div class="tab-pane" id="store-language<?php echo $language['language_id']; ?>">
                  ...
                  <div class="form-group">
                    ...
                    <div class="form-group">
                        <label class="col-sm-2 control-label" for="input-delivery<?php echo $language['language_id']; ?>"><span data-toggle="tooltip" data-container="#tab-general" title="<?php echo "Информация о доставке"; ?>"><?php echo "Информация о доставке"; ?></span></label>
                        <div class="col-sm-10">
                            <textarea name="config_langdata[<?php echo $language['language_id']; ?>][delivery]" rows="15" placeholder="Информация о доставке" id="input-delivery<?php echo $language['language_id']; ?>" class="form-control"><?php echo isset($config_langdata[$language['language_id']]) ? $config_langdata[$language['language_id']]['delivery'] : ''; ?></textarea>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-2 control-label" for="input-bonus<?php echo $language['language_id']; ?>"><span data-toggle="tooltip" data-container="#tab-general" title="<?php echo "Информация о бонусах"; ?>"><?php echo "Информация о бонусах"; ?></span></label>
                        <div class="col-sm-10">
                            <textarea name="config_langdata[<?php echo $language['language_id']; ?>][bonus]" rows="10" placeholder="Информация о бонусах" id="input-bonus<?php echo $language['language_id']; ?>" class="form-control"><?php echo isset($config_langdata[$language['language_id']]) ? $config_langdata[$language['language_id']]['bonus'] : ''; ?></textarea>
                        </div>
                    </div>
                </div>
                <?php } ?>
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-fax"><?php echo "Телефон 2"; ?></label>
                <div class="col-sm-10">
                  <input type="text" name="config_fax" value="<?php echo $config_fax; ?>" placeholder="<?php echo "Телефон 2"; ?>" id="input-fax" class="form-control" />
                </div>
              </div>
              <div class="form-group">
