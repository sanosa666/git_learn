...
//var_dump($results);
    ...
    public function getForm() {
        ...
        } elseif (isset($this->request->get['article_list_id'])) {
            $data['article_description'] = $this->model_blog_articlelist->getArticleListDescriptions($this->request->get['article_list_id']);
        } else {
            $data['article_description'] = array();
        }
//        var_dump($data['article_description']);
        ...
        if (isset($this->request->post['image'])) {
            ...
            $data['image'] = $article_list_info['image'];
        } else {
            $data['image'] = '';
        }
        ...
        } elseif (!empty($article_list_info) && is_file(DIR_IMAGE . $article_list_info['image'])) {
            $data['thumb'] = $this->model_tool_image->resize($article_list_info['image'], 100, 100);
        } else {
