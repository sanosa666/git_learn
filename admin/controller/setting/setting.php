...
class ControllerSettingSetting extends Controller {
	...
	public function index() {
      ...
      $this->request->post['config_delivery'] = $this->request->post['config_langdata'][$front_language_id]['delivery'];
      $this->request->post['config_bonus'] = $this->request->post['config_langdata'][$front_language_id]['bonus'];
